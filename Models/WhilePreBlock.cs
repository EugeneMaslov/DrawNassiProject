...
namespace DrawNassiProject.Models
{
    class WhilePreBlock : Block
    {
        ...
        public WhilePreBlock(Color color, Color fontColor, int key, int x, int y, int width, int height, string text)
        {
        ...
        public override DrawNassi Draw(DrawNassi drawNassi)
        {
            ...
            drawNassi.DrawFouth(this.blockInternalColor, fontInternalColor, Width, Height, text);
            return drawNassi;
        }
    }
}
